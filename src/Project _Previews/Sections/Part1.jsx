...
function Part1({ title, description, liveSite, gitCode , sitelabel='Live Site'}) {
  ...
  return (
    <motion.div className='w-full md:w-1/3 flex flex-col justify-between p-5 text-black md:ml-32 bg-red-100'
    ...
    >
      ...
      <div className='flex flex-col p-12 gap-2'>
        ...
        <div className='mt-12 flex flex-col'>
          <span className='text-md text-blue-900'>View the Project on GitHub:</span>
